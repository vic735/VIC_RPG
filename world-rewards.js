(function(root){
 ...
 function enemy(type,rng=Math.random,mapId=null){const e=D.monsters[type],map=D.maps?.[mapId],dropPool=map?.rewardPoolIds?.[0]||e?.dropPool;return dropPool&&rng()<(e?.dropChance||0)?[pool(dropPool,rng)]:[];}
