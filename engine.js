(function (root) {
  ...
  class Battle {
    ...
    damageValue(actor,target,move,critical=false,trace){
      ...
      let damage=actor.runtime.modify('damage',maximum*move.multiplier*(actor===this.player&&this.options.balance50?D.adventure.balance50.resourceDamage:1),ctx,trace);
      ...
      damage*=R.elementMultiplier(move.elements,target.elements);if(critical)damage*=this.rule('critMultiplier',actor,ctx);
